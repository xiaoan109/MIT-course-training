...
//
// On Wed Sep 25 05:36:22 UTC 2024
//
//
// Ports:
// Name                         I/O  size props
...
module mkFIRFilter(CLK,
  ...
  // submodule outfifo
  assign outfifo$D_IN = x__h805[31:16] ;
  ...
  assign _872_MUL_IF_r5_0_BIT_15_31_THEN_NEG_r5_0_CONCAT_ETC___d135 =
	     32'd872 * x__h21242 ;
  assign x__h15177 = r3[15] ? -x__h15193 : x__h15193 ;
  assign x__h15193 = { r3, 16'd0 } ;
  assign x__h21242 = r5[15] ? -x__h21258 : x__h21258 ;
  assign x__h21258 = { r5, 16'd0 } ;
  assign x__h27340 = r7[15] ? -x__h27356 : x__h27356 ;
  assign x__h27356 = { r7, 16'd0 } ;
  assign x__h3148 = infifo$D_OUT[15] ? -x__h3164 : x__h3164 ;
  assign x__h3164 = { infifo$D_OUT, 16'd0 } ;
  assign x__h805 =
	     x__h817 +
  ...
  assign x__h9152 = r1[15] ? -x__h9168 : x__h9168 ;
  assign x__h9168 = { r1, 16'd0 } ;
  assign y_f__h10204 =
